...
class NotificationControllerTest {
    ...
    void createNotificationDelegatesToService() {
        ResponseEntity<Void> response = controller.createNotification(7, "Title", "Message");
    ...
    void notifyUserUsesAdminNotificationTitle() {
        ResponseEntity<String> response = controller.notifyUser(9, "Check this");
    ...
    void notifyAllFetchesUsersFromAuthServiceAndCreatesNotifications() {
        ...
        ResponseEntity<String> response = controller.notifyAll("Broadcast");
    ...
    void getNotificationStatusReturnsUserNotifications() {
        ...
        ResponseEntity<List<Notification>> response = controller.getNotificationStatus(4);
    ...
    void markAsReadReturnsConfirmation() {
        ResponseEntity<String> response = controller.markAsRead(12);
